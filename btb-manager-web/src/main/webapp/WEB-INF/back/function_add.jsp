...
<div data-options="region:'center'">
	<form id="functionForm" method="post" action="${pageContext.request.contextPath}/function/add">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>父功能点</td>
						<td>
							<input name="pid" class="easyui-combobox" data-options="valueField:'id',
							textField:'name',url:'${pageContext.request.contextPath}/function/listAll'"/>
						</td>
					</tr>
					<tr>
						<td>描述</td>
