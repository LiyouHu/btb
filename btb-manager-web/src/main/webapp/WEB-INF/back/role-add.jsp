...
<script type="text/javascript">
	$(function(){
		...
		$.ajax({
			url : '${pageContext.request.contextPath}/function/listAll',
			type : 'POST',
			dataType : 'text',
		...
		$('#save').click(function(){
			...
			if(b){
				...
				for(var i=0;i<nodes.length;i++){
					var id = nodes[i].id; //nodes.id中的id为json数据中field名
					array.push(id);
				}
...
<body class="easyui-layout">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="roleForm" method="post" action="${pageContext.request.contextPath}/role/add">
