	...
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        <tr>
	            <td>商品类别:</td>
	            <td>
	            	<a href="javascript:void(0)" class="easyui-linkbutton selectItemCat">选择类别</a>
	        ...
	        <tr>
	         ...
	         <tr>
	            <td>是否推广商品:</td>
	            <td><input type="radio" name="promote" value="0" CHECKED/><span style="font-size:13px;color:#1E90FF">普通</span>
...
<script type="text/javascript">
	...
	function submitForm(){
		...
		//取商品价格，单位为“分”
		$("#itemAddForm [name=price]").val(($("#itemAddForm [name=priceView]").val() *100).toFixed(0));
		$("#itemAddForm [name=retail]").val(($("#itemAddForm [name=retailView]").val() *100).toFixed(0));
